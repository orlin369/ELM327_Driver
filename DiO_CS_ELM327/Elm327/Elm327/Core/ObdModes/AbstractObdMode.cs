...
namespace Elm327.Core.ObdModes
{
    ...
    public abstract class AbstractObdMode
    {
        ...
        internal AbstractObdMode(Driver elm, string obdModeIdentifier)
        {
        ...
        /// </summary>
        protected MeasuringUnitType MeasuringUnitType
        {
            get
            {
        ...
        private string[] ParseMultilinePidResponse(string message)
        {
            ...
            string[] lines = message.Split(Driver.MESSAGE_TERMINATOR_CHAR);
        ...
        protected string[] GetPidResponse(string pid)
        {
            ...
            if (message.IndexOf(Driver.MESSAGE_TERMINATOR_CHAR) > -1)
